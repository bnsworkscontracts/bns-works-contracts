  ...
  return <header className={`site-header ${scrolled || path !== '/' ? 'is-solid' : ''}`}>
    <div className="shell header-inner">
      <AppLink to="/" className="brand" onClick={() => setOpen(false)} ariaLabel="BNS Works home">
        <img src="/images/brand/bns-logo.png" alt="BNS Works Contracts Private Limited" />
      </AppLink>
  ...
  return <>
    <footer className="footer">
      <div className="shell footer-top">
        <div><img className="footer-logo" src="/images/brand/bns-logo.png" alt="BNS Works Contracts Private Limited" /><p>General construction, civil works and infrastructure execution across Punjab.</p></div>
...
function Hero() {
  return <section className="hero"><img className="hero-image" src="/images/general/bns-hero-construction.png" alt="AI-generated visual of a completed and in-progress construction development"/><div className="hero-shade"></div><span className="image-disclaimer image-disclaimer--hero">AI-generated visual</span><div className="shell hero-content">
...
export default function SiteApp() { const path = usePathname(); if (path === '/') return <Home/>; if (path === '/about') return <About/>; if (path === '/services') return <Services/>; if (path === '/capabilities') return <Capabilities/>; if (path === '/contact') return <Contact/>; return <NotFound/> }
